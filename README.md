...
The above data are a bit stale and do not reflect recent performance enhancements. See [_Metrics_](https://github.com/jrte/ribose/wiki/Metrics) for more recent benchmarking and compression metrics.
