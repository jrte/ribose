...
## More Examples
Here are some more examples to get things rolling. These are abridged from the ginr source for the patterns in the ribose test suite (`patterns/test/*.inr`).
### Hello World
